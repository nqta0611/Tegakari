...
public class Lobby extends Observable implements Serializable
{
     ...
     */
    private ThemeType themeType = ThemeType.GREEK;
    /**
    ...
    /**
     * Sets the New Theme for the Game.
     * @param newTheme the new Theme for the game.
     */
    public void newTheme(ThemeType newTheme)
    {
