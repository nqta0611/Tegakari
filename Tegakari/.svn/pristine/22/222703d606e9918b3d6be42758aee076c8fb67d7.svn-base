...
public class SuggestionAndMoveDialog extends javax.swing.JDialog implements I_SuggestionAndMove
{
    ...
    private void initComponents() {
        ...
        labelSuspect.setText("Suspect(123456)");
        ...
        suggestion.setText("Make Suggestion(C)");
        ...
        buttonOK.setText("<HTML><U>O</U>K<HTNML>");
        buttonOK.setName("okButton"); // NOI18N

        buttonReset.setText("Reset(Z)");
        ...
        layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                ...
                .add(buttonReset)
                .add(18, 18, 18)
                .add(buttonOK, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(22, 22, 22))
